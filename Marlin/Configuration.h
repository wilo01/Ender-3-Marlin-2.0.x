...
//============================= SCARA Printer ===============================
//===========================================================================
// For a SCARA printer start with the configuration files inf
...
#define STRING_CONFIG_H_AUTHOR "(DarO, Edner-3 03.2020)"  // Who made the changes.
...
#define PIDTEMP
#define BANG_MAX 128 //128     // Limits current to nozzle while in bang-bang mode; 255=full current
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //PID TUNE OLD BANG_MAX 128
  #define DEFAULT_Kp 9.35
  #define DEFAULT_Ki 1.63
  #define DEFAULT_Kd 13.43
  //PID NEW BANG MAX 135
  //#define DEFAULT_Kp 7.87
  //#define DEFAULT_Ki 1.23
  //#define DEFAULT_Kd 12.57
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //PID TUNE
  #define DEFAULT_bedKp 222.17
  #define DEFAULT_bedKi 44.38
  #define DEFAULT_bedKd 741.54
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 1000, 100000 }
